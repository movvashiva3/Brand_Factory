...
class _CategoryPageState extends State<CategoryPage> {
  ...
  void buyItem(String item) {
    ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Bought $item'))
    );
            ...
            Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  SizedBox(height: 20,),
                  FadeInUp(duration: Duration(milliseconds: 1500), child:  makeProduct(image: 'assets/images/mobile.jpeg', title: 'Mobiles', price: '900\$')),
                  FadeInUp(duration: Duration(milliseconds: 1600), child:  makeProduct(image: 'assets/images/batalu.jpg', title: 'Clothes', price: '150\$')),
                  FadeInUp(duration: Duration(milliseconds: 1700), child:  makeProduct(image: 'assets/images/Sunglasses.jpg', title: 'SunGlasses', price: '15\$')),
                  FadeInUp(duration: Duration(milliseconds: 1800), child:  makeProduct(image: 'assets/images/perfumes.jpeg', title: 'Perfume', price: '90\$')),
                  FadeInUp(duration: Duration(milliseconds: 1900), child:  makeProduct(image: 'assets/images/bracelet.jpeg', title: 'Bracelet', price: '10\$')),
                ],
              ),
            )
          ],
                      ...
                      FadeInUp(
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                              ...
                              child: Center(
                                child: Icon(Icons.payment, size: 18, color: Colors.grey[700],),
                              )
                          ),
                        ),
                      ),
